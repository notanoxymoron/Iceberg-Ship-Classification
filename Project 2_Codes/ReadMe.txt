...
1. Base CNN model:
            Batch Size:   32       Epoch:   20        Steps/Epoch: 1283     Channels: 2      
 ...
            CNN Layers :  3 layers              MLP hidden layers: 2 layers
            Activation function: RELU for all except output with sigmoid function

2. CNN-1 model:
            Batch Size:   32       Epoch:   20        Steps/Epoch:  42        Channels: 3      
 ...
            CNN Layers :  4 layers              MLP hidden layers: 2 layers
            Activation function: RELU for all except output with sigmoid function.
...
4. CNN-3 model: 
            Batch Size:   32       Epoch:   50        Steps/Epoch:  42        Channels: 3      
            Augmentation: Datagenerator (shift,rotate, width and height adjustments)        
            Callbacks: Annealer learning rate scheduler       
            Dropout: 20 to 30 % dropout in all layers of CNN and Fully connected MLP.
            Batch Normalization:  Not used
...
5. CNN-4 model: 
            Batch Size:   32       Epoch:   30        Steps/Epoch:  42        Channels: 3      
            Augmentation: Datagenerator (shift,rotate, width and height adjustments)        
            Callbacks: Annealer learning rate scheduler       
            Dropout: 20 to 30 % dropout in all layers of CNN and Fully connected MLP.
            Batch Normalization:  Not used            
 ...
            Activation function: RELU for all except output with sigmoid function.
6. CNN-5 model: 
            Batch Size:   32       Epoch:  10      Steps/Epoch:  42        Channels: 3      
            Augmentation: Datagenerator (shift,rotate, width and height adjustments)        
            Callbacks: Annealer learning rate scheduler       
            Dropout: 20 to 30 % dropout in all layers of CNN and Fully connected MLP.
            Batch Normalization:  Not used
...
8. CNN-7 model:
            Batch Size:   32       Epoch:   20       Steps/Epoch:  128        Channels: 3      
            Augmentation: Datagenerator (shift,rotate, width and height adjustments)        
            Callbacks: Annealer learning rate scheduler       
            Dropout: 20 to 30 % dropout in all layers of CNN and Fully connected MLP.
            Batch Normalization:  Not used
