# -*- coding: utf-8 -*-
"""
Created on Sat Dec 16 16:53:32 2017
...
def get_model():
    ...
    # CNN 1
    model.add(Conv2D(64, kernel_size=(3, 3),activation='relu',kernel_regularizer=l2(0.005), input_shape=(75, 75, 3)))
    ...
    #CNN 4
    model.add(Conv2D(64, kernel_size=(3, 3), kernel_regularizer=l2(0.005),activation='relu'))
    model.add(MaxPooling2D(pool_size=(2, 2), strides=(2, 2)))   
    model.add(Dropout(0.3))
...
history = model.fit_generator(datagen.flow(X_train, Y_train, batch_size=batch_size),
                            steps_per_epoch=len(X_train)/batch_size, epochs=epochs, callbacks=[annealer],
...
#submission.to_csv('Project 2_sub6.csv', index=False)